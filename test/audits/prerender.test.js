...
describe('Prerender Audit', () => {
  ...
  describe('Opportunity Data Mapper', () => {
    it('should create opportunity data with correct structure', () => {
      ...
      expect(opportunityData.title).to.equal('Content Gain Opportunity');
      ...
      expect(opportunityData.tags).to.include('Pre-rendering');
      expect(opportunityData.tags).to.include('Content Gain');
