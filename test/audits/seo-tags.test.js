...
import {
  ...
  HIGH,
  MODERATE,
} from '../../src/seo-tags/constants.js';
import SeoChecks from '../../src/seo-tags/seo-checks.js';
import auditTagsForSEO from '../../src/seo-tags/handler.js';
...
describe('SeoTags', () => {
  ...
  describe('handler method', () => {
    ...
    it('should return notFound if site is not found', async () => {
      ...
      const result = await auditTagsForSEO(message, context);
