...
describe('Internal Links Opportunity Data Mapper', () => {
  describe('createOpportunityData', () => {
    it('should create opportunity data with all required fields', () => {
      ...
      expect(result.runbook).to.include('Experience_Success_Studio_Broken_Internal_Links_Runbook');
    ...
    it('should use OPPORTUNITY_TYPES.BROKEN_INTERNAL_LINKS constant for tags', () => {
    ...
    it('should have correct guidance steps', () => {
      ...
      expect(result.guidance.steps[0]).to.include('Update each broken internal link');
      expect(result.guidance.steps[2]).to.include('Monitor internal links');
    });
