...
describe('createLowFormViewsOpportunities handler method', () => {
  ...
  it('should create new high page views low form views opportunity', async () => {
    ...
    expect(logStub.info).to.be.calledWith('[Form Opportunity] [Site Id: test-site-id] [Opportunity Type: high-page-views-low-form-views] successfully synced opportunity for high page views low form views oppty type');
  });
  ...
  it('should throw error if fetching high page views low form navigation opportunity fails', async () => {
    ...
    expect(logStub.error).to.be.calledWith('[Form Opportunity] [Site Id: test-site-id] [Opportunity Type: high-page-views-low-form-views] fetching opportunities failed with error: some-error');
  });
  ...
  it('should throw error if creating high page views low form navigation opportunity fails', async () => {
    ...
    expect(logStub.error).to.be.calledWith('[Form Opportunity] [Site Id: test-site-id] [Opportunity Type: high-page-views-low-form-views] creating forms opportunity for high page views low form views failed with error: some-error');
  });
