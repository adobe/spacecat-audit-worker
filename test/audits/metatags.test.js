  ...
  describe('SeoChecks', () => {
    ...
    describe('createLengthCheckText', () => {
      it('should create the correct length check message for a tag within the limit', () => {
        ...
        expect(message).to.equal('The title tag on this page has a length of 53 characters, which is within the recommended length of 25-70 characters.');
      });
      ...
      it('should create the correct length check message for a tag below the limit', () => {
        ...
        expect(message).to.equal('The title tag on this page has a length of 5 characters, which is below the recommended length of 25-70 characters.');
      });

      it('should create the correct length check message for a tag above the limit', () => {
        const longTitle = 'L'.repeat(71);
        const message = SeoChecks.createLengthCheckText(TITLE, longTitle);

        expect(message).to.equal('The title tag on this page has a length of 71 characters, which is above the recommended length of 25-70 characters.');
      });
    });
