...
describe('agentic traffic mapper', () => {
  ...
  it('maps both supported Meta user agents to the Meta platform', async () => {
    const site = {
      getId: () => 'site-1',
      getBaseURL: () => 'https://www.example.com',
      getConfig: () => ({
    ...
    const rows = [
      {
        ...
        user_agent_display: 'Meta-ExternalAgent',
        status: 200,
        number_of_hits: 2,
        avg_ttfb_ms: 10,
        country_code: 'US',
      ...
      {
        agent_type: 'Chatbots',
        user_agent_display: 'Meta-ExternalFetcher',
        status: 200,
        number_of_hits: 3,
        avg_ttfb_ms: 20,
        country_code: 'US',
