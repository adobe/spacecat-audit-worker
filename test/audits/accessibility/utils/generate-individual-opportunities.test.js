...
import { createIndividualOpportunity } from '../../../../src/accessibility/utils/generate-individual-opportunities.js';

describe('Accessibility Generate Individual Opportunities - createIndividualOpportunity', () => {
  let sandbox;
  let mockContext;
  let mockOpportunity;
  ...
  it('should create individual opportunity with merged tags', async () => {
    ...
    expect(createdOpportunityData.status).to.equal('NEW');
  });
  ...
  it('should merge hardcoded tags based on opportunity type', async () => {
    ...
    await createIndividualOpportunity(opportunityInstance, auditData, mockContext);
