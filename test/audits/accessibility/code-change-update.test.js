...
describe('AccessibilityCodeChangeHandler', () => {
  let sandbox;
  let context;
  let mockDataAccess;
  let mockOpportunity;
  ...
  describe('Main Handler Function', () => {
    it('should successfully process updates with matching suggestions', async () => {
      ...
      const handler = await esmock('../../../src/accessibility/autofix-handlers/code-change-update.js', {
    ...
    it('should return badRequest when no data provided', async () => {
      ...
      expect(context.log.error).to.have.been.calledWith(
        'AccessibilityCodeChangeHandler: No data provided in message',
      );
    });
