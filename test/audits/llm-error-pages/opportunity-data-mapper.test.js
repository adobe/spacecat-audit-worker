...
describe('LLM Error Pages - createOpportunityData', () => {
  it('should return correct Opportunity data for status code 404', () => {
  ...
  it('should return correct Opportunity data for status code 403', () => {
  ...
  it('should return correct Opportunity data for status code 5xx', () => {
  ...
  it('should include the correct common fields for every status code', () => {
