...
describe('dataContainsCode', () => {
  ...
  describe('returns true for valid data', () => {
    ...
    it('accepts data with additional properties in codeInfo', () => {
      const data = {
        importResults: [{
          result: [{
    ...
    it('accepts data with multiple importResults (uses first)', () => {
      const data = {
        importResults: [
          {
            result: [{
    ...
    it('accepts data with multiple results (uses first)', () => {
      const data = {
        importResults: [{
          result: [
            {
  ...
  describe('returns false for invalid data', () => {
    ...
    it('rejects non-objects (string)', () => {
      expect(dataContainsCode('not an object')).to.be.false;
    });

    it('rejects non-objects (number)', () => {
    ...
    it('rejects data missing importResults', () => {
      const data = { otherProperty: 'value' };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with null importResults', () => {
      const data = { importResults: null };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with non-array importResults', () => {
      const data = { importResults: 'not-an-array' };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with empty importResults array', () => {
      const data = { importResults: [] };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with null first importResult', () => {
      const data = { importResults: [null] };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with non-object first importResult', () => {
      const data = { importResults: ['not-an-object'] };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with importResult missing result property', () => {
      const data = {
        importResults: [{ otherProperty: 'value' }]
      };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with null result', () => {
      const data = {
    ...
    it('rejects data with non-array result', () => {
      const data = {
        importResults: [{ result: 'not-an-array' }]
      };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data with empty result array', () => {
      const data = {
    ...
    it('rejects data with null codeInfo', () => {
      const data = {
        importResults: [{ result: [null] }]
      };
      expect(dataContainsCode(data)).to.be.false;
    ...
    it('rejects data with non-object codeInfo', () => {
      const data = {
        importResults: [{ result: ['not-an-object'] }]
      };
      expect(dataContainsCode(data)).to.be.false;
    });

    it('rejects data missing codeBucket', () => {
      const data = {
        importResults: [{
          result: [{
            codePath: 'path/to/code',
    ...
    it('rejects data missing codePath', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: 'my-bucket',
    ...
    it('rejects data with non-string codeBucket', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: 123,
    ...
    it('rejects data with null codeBucket', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: null,
    ...
    it('rejects data with non-string codePath', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: 'my-bucket',
    ...
    it('rejects data with empty string codeBucket', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: '',
    ...
    it('rejects data with empty string codePath', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: 'my-bucket',
    ...
    it('rejects data with whitespace-only codeBucket', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: '   ',
    ...
    it('rejects data with whitespace-only codePath', () => {
      const data = {
        importResults: [{
          result: [{
            codeBucket: 'my-bucket',
