...
export const TEST_AWS_ENV = 'prod';
export const CUSTOM_AWS_ENV = 'dev';
export const TEST_STANDARD_BUCKET = `cdn-logs-adobe-${TEST_AWS_ENV}`;
export const CUSTOM_STANDARD_BUCKET = `cdn-logs-adobe-${CUSTOM_AWS_ENV}`;
