...
describe('Metatags Opportunity Data Mapper', () => {
  describe('createOpportunityData', () => {
    it('should create opportunity data with correct structure', () => {
      ...
      expect(result).to.have.property('title', 'Stand out in search results with clean meta tags — fixes ready for the missing or invalid ones');
    ...
    it('should preserve props in data object', () => {
      const props = {
