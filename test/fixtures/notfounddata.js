    ...
    data: [
      {
        ...
        actions: '10000',
        url: 'https://www.abc.com/kr/acrobat/hub/how-to/how-to-convert-pdf-to-image.html',
        all_sources: ['https://post.naver.com/viewer/postView.naver'],
        source_count: 1,
        actions_per_view: '1',
      },
      {
        ...
        actions: '8000',
        url: 'https://www.abc.com/sea/acrobat/online/merge-pdf.html',
        all_sources: ['https://brandinside.asia/', 'https://wikipedia.com', 'google.com'],
        source_count: 3,
        actions_per_view: '1',
      },
      {
        ...
        views: '700',
        actions: '400',
        url: 'https://www.abc.com/sea/acrobat/online/pdf-to-word.html',
        all_sources: [],
        source_count: 0,
        actions_per_view: '1',
      },
      {
        ...
        views: '100',
        actions: '100',
        url: ['https://www.abc.com/sea/acrobat/online/pdf-to-word22.html'],
        all_sources: ['https://www.abc.com/', 'https://wikipedia.com'],
        source_count: 2,
        actions_per_view: '1',
      },
    ],
