...
export const guidance = [
  {
    ...
    data: {
      ...
      suggested_urls: ['https://foo.com/redirects-throws-error-1', 'https://foo.com/redirects-throws-error-2'],
  ...
  },
  {
    ...
    data: {
      ...
      suggested_urls: ['https://foo.com/returns-429-suggestion-1', 'https://foo.com/returns-429-suggestion-2'],
      ai_rationale: 'The suggested URLs are similar to the original URL and are likely to be the correct destination.',
    },
  },
  {
    ...
    data: {
      ...
      suggested_urls: ['https://foo.com/not-excluded-suggestion-1', 'https://foo.com/not-excluded-suggestion-2'],
