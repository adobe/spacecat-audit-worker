...
export default class FirefallClient {
   ...
   */
  async #submitPrompt(body, path, additionalHeaders = {}) {
  ...
  async fetchChatCompletion(prompt, options = {}) {
    ...
    try {
      ...
      chatSubmissionResponse = await this.#submitPrompt(JSON.stringify(body), '/v2/chat/completions', additionalHeaders);
