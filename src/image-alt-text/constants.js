...
export const PREFLIGHT_ALT_GUIDANCE_TYPE = 'guidance:preflight-image-alt-text';
export const PREFLIGHT_ALT_OBSERVATION = 'Missing or low-quality alt text on images';
