...
import {
  accessibilityIssuesImpact, accessibilitySolutions, accessibilitySuggestions, accessibilityUserImpact,
...
function generateAccessibilityIssuesOverviewSection(issuesOverview) {
  ...
  sortedIssues.forEach((issue) => {
    let impact = accessibilityIssuesImpact[issue.rule] || '';
...
function generateQuickWinsOverviewSection(quickWinsData, enhancedReportUrl) {
  ...
  sortedGroups.forEach((group) => {
    ...
    let impact = accessibilityIssuesImpact[firstIssue.id] || '';
