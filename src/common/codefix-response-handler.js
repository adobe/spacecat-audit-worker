 ...
 *
 * Supports two message formats for backwards compatibility:
 *
 * NEW FORMAT (with aggregation_key):
 * {
 *   "siteId": "<site-id>",
 ...
 *         "aggregation_key": "<aggregation-key>", // required - used to match suggestions
 *         "code_fix_path": "<s3-path>", // optional - S3 path to report.json
 ...
 * }
 *
 * OLD FORMAT (with type array, backwards compatible):
 * {
 *   "siteId": "<site-id>",
 *   "type": "codefix:*",
 *   "data": {
 ...
 * }
 *
 * If aggregation_key is provided, it takes precedence over type array.
 * If code_fix_path and code_fix_bucket are provided (only with aggregation_key),
 * they take priority over the default path construction:
 * fixes/${siteId}/${urlSourceHash}/${aggregationKey}/report.json
 *
