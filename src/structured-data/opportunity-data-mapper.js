...
export function createOpportunityData() {
  return {
    ...
    origin: 'AUTOMATION',
    title: 'Structured data fixes to help enhance search results ready for deployment',
    description: 'Rich structured data increases visibility and engagement by adding rich snippets to search listings.',
    guidance: {
      steps: [],
    },
    tags: ['Traffic acquisition', 'tech-seo'],
    data: {
      dataSources: [DATA_SOURCES.SEO, DATA_SOURCES.GSC, DATA_SOURCES.SITE],
    },
  };
}
