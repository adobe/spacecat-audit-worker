...
export const CANONICAL_CHECKS = Object.freeze({
  ...
  CANONICAL_TAG_OUTSIDE_HEAD: {
    ...
    title: 'Canonical Tag Outside Head',
  ...
  CANONICAL_URL_STATUS_OK: {
    ...
    title: 'Canonical URL Status Not OK',
  ...
  CANONICAL_URL_NO_REDIRECT: {
    ...
    title: 'Canonical URL Has Redirect',
  ...
  CANONICAL_URL_4XX: {
    ...
    title: 'Canonical URL Returns 4xx Error',
  ...
  CANONICAL_URL_5XX: {
    ...
    title: 'Canonical URL Returns 5xx Error',
  ...
  CANONICAL_URL_FETCH_ERROR: {
    ...
    title: 'Canonical URL Fetch Error',
