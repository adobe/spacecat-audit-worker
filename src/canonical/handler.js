...
export async function validateCanonicalTag(url, log, options = {}, isPreview = false) {
  ...
  try {
    ...
    log.info(`[DEBUG] Response status1: ${response.status}, HTML length: ${html.length}, Contains 'canonical': ${html.includes('canonical')}, First 500 chars: ${html.substring(0, 500)}`);
