...
async function calculateProjectedTraffic(context, site, detectedTags, log) {
  ...
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(0, 50)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(50, 100)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(100, 150)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(150, 200)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(200, 250)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(250, 300)}`);
  log.warn(`Preprocessed data map: ${Array.from(rumTrafficDataMap.entries()).slice(300)}`);
