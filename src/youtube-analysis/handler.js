...
async function runYouTubeAnalysisAudit(url, context, site, auditContext = {}) {
  ...
  try {
    ...
    if (error instanceof StoreEmptyError) {
      ...
      olog.skip('audit_analysis_readiness_resolved', 'URL store empty, requesting a scoped scrape for youtube.com', {
    ...
    if (error instanceof DrsNoContentAvailableError) {
      ...
      olog.skip('audit_analysis_readiness_resolved', 'URLs stored but not scraped in DRS yet, requesting a scrape for youtube.com', {
