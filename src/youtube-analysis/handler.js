  ...
  try {
    ...
    return {
      auditResult: {
        ...
        config: { ...youtubeConfig, urlLimit, enableBrandProfile },
        storeData,
...
async function sendMystiqueMessagePostProcessor(auditUrl, auditData, context) {
  ...
  try {
    ...
    await postMessageOptional(
      context,
      debugSlackContext?.channelId,
      `:mag: *[ENABLE_BRAND_PROFILE_DEBUG] youtube-analysis* enableBrandProfile=${message.data.enableBrandProfile}\n`
