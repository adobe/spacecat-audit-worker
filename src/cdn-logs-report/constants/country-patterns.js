...
export const DEFAULT_COUNTRY_PATTERNS = [
  ...
  { name: 'path_3letter_full', regex: '^[^/]+//[^/]+/?([a-z]{3})(?:/|$)' },
  { name: 'path_2letter_full', regex: '^[^/]+//[^/]+/?([a-z]{2})(?:/|$)' },
  { name: 'locale_dash_full', regex: '^[^/]+//[^/]+/?[a-z]{2}-([a-z]{2})(?:/|$)' },
  { name: 'locale_underscore_full', regex: '^[^/]+//[^/]+/?([a-z]{2})_[a-z]{2}(?:/|$)' },
