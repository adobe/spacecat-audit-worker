...
WHERE year  = '{{year}}'
  ...
  AND REGEXP_LIKE(request_user_agent, '(?i)(ChatGPT|GPTBot|OAI-SearchBot|OAI-AdsBot|Perplexity|Claude|Anthropic|Gemini|Copilot|MistralAI-User|Google-NotebookLM|Google-GeminiNotebook|GoogleOther|Google-?Agent|Google-Extended|Googlebot|bingbot|Amzn-User|Shap(Bot|-User)|Manus-User|Keenable-User|meta-externalagent|meta-externalfetcher|meta-webindexer|^Google$)')
