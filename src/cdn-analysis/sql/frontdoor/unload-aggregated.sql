UNLOAD (
  ...
  WHERE year  = '{{year}}'
    ...
    -- agentic and LLM-attributed traffic never has self-referer (no referrer field in Azure Front Door logs)
    -- This filter is skipped for Azure Front Door as referrer information is not available
