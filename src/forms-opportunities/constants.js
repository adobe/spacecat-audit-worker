...
export const FORM_TYPES_TO_IGNORE = ['search form', 'login form', 'zip code search form', 'filter form', 'otp form', 'calculator form', 'product listing/selection form', 'cart form', 'file upload form', 'payment form', 'password reset'];
