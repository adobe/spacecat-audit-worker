...
export const DAILY_PAGEVIEW_THRESHOLD = 200;
...
export async function generateOpptyData(formVitals, context) {
  ...
  return Promise.all(
    getHighFormViewsLowConversionMetrics(formVitalsCollection, INTERVAL)
...
export async function generateOpptyDataForHighPageViewsLowFormNav(formVitals, context) {
  ...
  return Promise.all(
    getHighPageViewsLowFormCtrMetrics(formVitalsCollection, INTERVAL)
