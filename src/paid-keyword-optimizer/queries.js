...
/**
 * Generates the low performing paid pages SQL query for keyword optimizer audit.
 * This query fetches pages with search channel traffic, grouped by path and trf_type,
 * to enable filtering for predominantly paid pages with high bounce rates.
 *
 ...
 */
export function getLowPerformingPaidPagesTemplate({
  siteId,
  tableName,
  temporalCondition,
  dimensionColumns,
