...
export function createOpportunityData(siteId, auditId, url, guidance) {
  return {
    ...
    title: 'FAQ Opportunities Based on Brand Presence Analysis',
    description: 'AI-generated FAQ suggestions based on frequently searched queries related to your brand and products.',
    status: 'NEW',
    guidance,
    tags: ['isElmo'],
    data: {
